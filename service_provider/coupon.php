...
<body>
    ...
    <section class="home" style="height: auto;">
        <div class="text">Add Tour Coupon Here</div>
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($result) > 0) {
									...
									<td>" . $row['discount'] . "</td>";
                                        ...
                                        echo '<td><a href="delete3.php?id=' . $row['id'] . '&&username=admin"><button  class="btn btn-danger">Delete</button></a></td>';
                                    }
                                }
