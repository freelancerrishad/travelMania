		...
		<div class="modal-content">
			...
			<form method="POST" action="add.php?username=' . $username . '">';
					...
					<div class="row form-group">
						<div class="col-sm-2">
							<label class="control-label modal-label">Guide Name:</label>
						</div>
						<div class="col-sm-10">
					...
					<div class="row form-group">
						<div class="col-sm-2">
							<label class="control-label modal-label">Guide Area:</label>
						</div>
						<div class="col-sm-10">
					...
					<div class="row form-group">
						<div class="col-sm-2">
							<label class="control-label modal-label">Guide Number:</label>
						</div>
						<div class="col-sm-10">
