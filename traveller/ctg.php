...
<body>
  ...
  <div class="p-5">
      <a href="#">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Hotel Name' . $row['title'] . '</h5>
      </a>
      <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Description' . $row['description'] . '</p>
      
      <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Town of Chittagang: ' . $row['town'] . '</p>
